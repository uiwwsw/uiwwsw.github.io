...
- Opening: the world assembles around a **fixed camera**. Earth starts entirely beyond the right edge and slides into its upper-right position; the lunar floor and rocks rise from entirely below the frame on a staggered 5.6-second sequence. There is no camera descent/tilt/zoom or changing sunlight. Offscreen offsets adapt to the viewport, including the atmosphere and terrain bounds. Manual controls remain live, reduced motion/reading skip, and returning home does not replay. No new bitmap or draw batch is added; mobile ground remains 13,545 vertices. See [world assembly QA](design/world-assembly-qa.md).

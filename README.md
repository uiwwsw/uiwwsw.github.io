...
- Wheel down or **drag your finger down** to approach Earth; drag up to retreat. Horizontal/diagonal touch gestures freely look left/right and up/down, including gestures begun over introductory text or star labels. Only predominantly vertical gestures travel; their small camera lean returns on release instead of accumulating pitch. Desktop dragging looks on both axes, and horizontal trackpad scrolling pans. A 100 px wheel notch requests 1.8% of the route, touch gain is 30% per screen height, and bounded travel speed/short coast keep bursts under control. Looking responds faster than flight.

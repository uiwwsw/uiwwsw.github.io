...
- The native bottom slider has a **52px-high input area and 44×44px draggable thumb**, with a quiet 22px visual halo, a filled track, keyboard focus outline and 0.1% steps. Its larger target is isolated from the canvas gesture recognizer; normal pinch and keyboard discovery behavior are retained. Sound starts muted and is generated locally with Web Audio.
